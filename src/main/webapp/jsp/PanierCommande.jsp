...
<body>
    <div class="container mt-5">
        <h1 class="mb-4"><a href="ServletPreparation?action=afficherCommandes" class="btn btn-primary">Afficher les commandes à préparer</a></h1>
        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-dark">
                ...
                <tr>
                    ...
                    <td><a href="ServletPreparation?action=<%= c.getIdCommande() %>"><%= c.getIdCommande() %></a></td>
