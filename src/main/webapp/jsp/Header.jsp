	...
	<div class="container">
		<div
			...
			<ul
				...
				<li class="d-flex d-row align-items-center">
			...
			<form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 d-flex d-row px-3"
				role="search" action="CtrlChercherArticles" method="get">
				<input type="text" name="inputData" type="search"
					class="form-control rounded-0" placeholder="Chercher..." aria-label="Search">
				<button type="submit" class="btn btn-sm btn-secondary text-white rounded-0"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg></button>
			</form>
			...
			<a href="ServletPanier"
		 	...
		 	<a href="/jsp/ListeCourse.jsp" class="text-white ms-3">
