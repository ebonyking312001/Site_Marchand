                                ...
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="list-group mb-4">
                                            <c:forEach
													var="contenuTypeProduit"
													items="${liste.contenuTypeProduit}">
                                                <a
														href="ListeArticlesParTypeProduit/${liste.idListe}/${contenuTypeProduit.idTypeProduit}"
                                        ...
                                        <ul>
                                            <c:forEach
													var="contenuArticle" items="${liste.contenuArticle}">
                                                <li>${contenuArticle.libelleArticle} - ${contenuArticle.marque} - ${contenuArticle.quantite}</li>
                                            </c:forEach>
                                        </ul>
                                        <div class="row text-left">
	                                        <div class="col-6">
	                    						<button id="delete_card_${liste.idListe}"
														class="checkout-btn btn btn-danger supprListe"
														data-idListeRm="${liste.idListe}">Supprimer liste</button>
	                    					</div>
	                    					<c:if test="${liste.contenuArticle != null}">
											<div class="col-6">
	                    						<a href=""><button
																class="checkout-btn addToCardFromL"
																data-idListeAddCard="${liste.idListe}">Ajouter au panier</button></a>
	                    					</div>
											</c:if>
